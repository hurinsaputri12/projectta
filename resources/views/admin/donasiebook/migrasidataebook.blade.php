...
@section('title')
 <title>Migrasi Data Ebook</title>
@endsection
                    ...
                    <div class="card-body card-block">
                        <form action="{{ route('admin.donasiebook.upmigrasidataebook', [$id]) }}" method="post" enctype="multipart/form-data"class="form-horizontal">
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9"><input type="text" name="judul_buku" placeholder="Judul Buku" class="form-control" value="{{$donasiebook->judul_buku}}"></div>
                            </div>
                                ...
                                <div class="col-12 col-md-9">
                                    <select name="kategori_id" id="select" class="form-control">
                                        @foreach ($kategori as $item)
                                            <option value="{{$item->id}}" @if($donasiebook->kategori_id == $item->id) {{'selected="selected"'}} @endif>{{$item->nama_kategori}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9"><input type="text" name="nama_pengarang" placeholder="Nama Pengarang" class="form-control" value="{{$donasiebook->nama_pengarang}}"></div>
                            </div>

                            <div class="row form-group">
                                <div class="col col-md-3"><label for="text-input" class="form-control-label">Tahun Terbit</label></div>
                                <div class="col-12 col-md-9"><input type="number" name="tahun_terbit" placeholder="Tahun Terbit" class="form-control" value="{{$donasiebook->tahun_terbit}}"></div>
                            </div>

                            <div class="row form-group">
                                <div class="col col-md-3"><label for="text-input" class="form-control-label">Penerbit</label></div>
                                <div class="col-12 col-md-9"><input type="text" name="penerbit" placeholder="Penerbit" class="form-control" value="{{$donasiebook->penerbit}}"></div>
                            </div>

                            <div class="row form-group">
                                <div class="col col-md-3"><label for="text-input" class="form-control-label">Jumlah Halaman</label></div>
                                <div class="col-12 col-md-9"><input type="number" name="jumlah_halaman" placeholder="Jumlah Halaman" class="form-control" value="{{$donasiebook->jumlah_halaman}}"></div>
                            </div>
                            ...
                            <div class="row form-group">
                                ...
                                <input type="text" name="donatur_id" class="form-control" hidden value="{{ $donasiebook->donatur }}"></div>
                            </div>
                            ...
                            <div class="card-footer">
                                ...
                                <a href="{{route('admin.donasiebook.daftardonasiebook')}}" type="" class="btn btn-danger btn-sm">
